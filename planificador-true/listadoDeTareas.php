            ...
            <?php
                ...
                foreach ($listado as $fila){
                    ...
                    <tr>
                        ...
                        <td class="text-center <?php echo $estadoTarea; ?>"><a href="confirmar_tarea.php?tra_id=<?php echo $fila['tra_id']; ?>"><span class="btn btn-primary glyphicon glyphicon-bell" title="Confirmar tarea realizada"></span></a></td>
                    </tr>
                <?php } ?>
                </tbody>
                <tr>
